            ...
            <div className="page-header -mt-7">
                <div className="container mx-auto">
                    <div className="flex flex-col items-center justify-center"
                        ...
                        <h3 className="display-4 text-white uppercase mb-2">Service</h3>
                        ...
                        <div className="md:7/12 lg:w-1/2">
                            ...
                            <div className="divide-y space-y-4 divide-gray-800">
                                <div className="mt-8 flex gap-4 md:items-center">
                                    ...
                                    <div className="w-5/6">
                                        <h4 className="font-semibold text-lg  text-indigo-500">24/7 Customer Support</h4>
                                        <p className="text-gray-500">Our team is always ready to assist you, no matter where you are.</p>
                                    </div>
                                </div>
                                <div className="pt-4 flex gap-4 md:items-center">
                                    <div className="w-12 h-12 flex gap-4 rounded-full bg-lime-100 bg-lime-900/20">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 m-auto  text-lime-600">
                                            <path fill-rule="evenodd" d="M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 001.144-.742 19.58 19.58 0 002.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 00-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 002.682 2.282 16.975 16.975 0 001.145.742zM12 13.5a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
                                        </svg>
                                    </div>
                                    <div className="w-5/6">
                                        <h4 className="font-semibold text-lg text-lime-600">Personalized Tours</h4>
                                        <p className="text-gray-500 ">We tailor your trips to your preferences for an unforgettable experience.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
