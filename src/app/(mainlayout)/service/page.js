        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mx-10">
          {services.map((service, i) => {
            return (
              <>
                <div
                  className="service-item bg-white text-center p-4 md:p-10"
                  key={i}
                >
                  <Image
                    src={service.img}
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {stat.map((s, i) => {
            return (
              <>
                <div
                  className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white "
                  key={i}
                >
                  <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-lime-400">
                    {s.tag === "tc" && (
                      <BsPeopleFill className="w-9 h-9 text-white" />
                    )}
                    {s.tag === "tb" && (
                      <BsBookmarkCheckFill className="w-9 h-9 text-white" />
                    )}
                    {s.tag === "tt" && (
                      <BsFillSignTurnSlightRightFill className="w-9 h-9 text-white" />
                    )}
                    {s.tag === "tv" && (
                      <BsHouseAddFill className="w-9 h-9 text-white" />
                    )}
                  </div>
            ...
            <div className="md:7/12 lg:w-1/2">
              ...
              <div className="divide-y space-y-4 divide-gray-800">
                ...
                <div className="pt-4 flex gap-4 md:items-center">
                  ...
                  <div className="w-5/6">
                    <h4 className="font-semibold text-lg text-lime-600">
                      Personalized Tours
                    </h4>
                    <p className="text-gray-500 ">
