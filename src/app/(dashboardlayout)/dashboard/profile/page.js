                ...
                <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    <div className="flex justify-center ">
                        <div className="relative -mt-20 z-20 rounded-full bg-white/20  backdrop-blur p-3" >
                            <Image src={user.photoURL} alt="profile" width={500} height={500} className="w-36 h-36 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
                            <label
                                htmlFor="profile"
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mx-auto max-w-180">
                            ...
                            <p className="mt-4">
                                A passionate traveler, embraces the world with an insatiable wanderlust. His journeys transcend mere destinations, weaving a tapestry of cultural immersion and unforgettable experiences. From bustling urban streets to serene landscapes, Asif&apos;s exploration is a blend of curiosity and respect. He delves into local traditions, relishes unique cuisines, and forges connections with diverse communities. Travel, for Asif, is a transformative odyssey, a constant source of self-discovery, and a collection of moments that paint the canvas of his nomadic soul.
                            </p>
                        </div>
