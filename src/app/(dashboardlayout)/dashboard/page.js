            ...
            <div className="dash-header">
                <div className="container mx-auto">
                    <div className="flex flex-col items-center justify-center"
                        ...
                        <h3 className="display-4 text-white uppercase mb-2">Dashboard</h3>
                    </div>
                </div>
            </div>
            <Status />
...
const Status = () => {
    return (
        <>
            <div className='overflow-hidden rounded-lg shadow transition hover:shadow-lg m-2 md:m-5 p-5'>
